...
const AddNote = (props) => {
  ...
  <button disabled={note.title.length<5||note.description.length<5} type="submit" className="btn btn-primary" onClick={handleClick} value={note.tag}>Add Note</button>
</form>
    </div>
    </div>
  )
